...
class Car{
    ...
    // Desctructor to delete static data members of the class
        ~Car(){
            cout<<"To Destruct the created object "<<name<<endl;
        }

    // Destructor to delete dynamically created data memebers of the class
        // ~Car(){
        //     cout<<"Car destroying "<<name<<endl;
        //     if(name != NULL)
        //         delete [] name;
        // }
...
int main(){
    ...
    Car *f = new Car(6666, 123, "Ford");   // Dynamically created object using 'new' keyword
    f->print();
    cout<<endl;

    delete f;       // Explicitly destroying the dynamically created object
    cout<<endl;
